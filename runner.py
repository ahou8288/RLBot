...
import PlayHelper
import array
# import bots/AlwaysTowardsBallAgent
from tkinter import *
from bots import NoJiggle
...
print("Creating NoJiggle Agents")
agent1 = NoJiggle.agent("blue")
agent2 = NoJiggle.agent("orange")
...
try:
    ...
    print("Program window closed unexpectedly.")

import resetDevices # Release all the buttons so your computer isn't messed up
